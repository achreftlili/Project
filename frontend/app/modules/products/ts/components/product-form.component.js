System.register(['angular2/core', "angular2/http", 'rxjs/add/operator/map', '../Entity/product', 'angular2/router'], function(exports_1) {
            ...
            ProductFormComponent = (function () {
                ...
                ProductFormComponent.prototype.onSubmit = function (model) {
                    ...
                    this.http.post('http://localhost:8000/products', JSON.stringify(product))
                        ...
                        .subscribe(function (data) { return _this.succes(data); });
                };
